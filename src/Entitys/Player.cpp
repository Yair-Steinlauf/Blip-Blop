...
Player::Player(sfPos pos, b2World* world)
	...
	m_gun(std::make_unique<Gun>(AnimationSet::Blip, std::make_unique<SingleShotStrategy>(), SIMPLE_SHOOT_TIME, DataLoader::getInstance().getSound(ObjectType::DeafultWeaponSound)))
{
