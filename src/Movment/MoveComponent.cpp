...
MoveComponent::MoveComponent(BaseEntity& entity, b2World* world)
    : m_entity(entity), m_world(world), m_direction(0.f, 0.f), m_speed(100.f)
{
    // נניח ש-entity יודע את המיקום שלו
...
void MoveComponent::update(float deltaTime) {
    ...
    float maxVelocity = 5.0f; // או מהירות שתראה טבעית
